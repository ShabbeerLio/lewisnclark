...
import TermnCondimg from "../../Assets/Termncond/termncond.webp"
        ...
        <div className='TermCond'>
            <div className='TermCond-main'>
                <div className="contact-head">
                    ...
                    <div className="TermCond-image">
                        <img src={TermnCondimg} alt="Lewis and Clark Tours" />
                    </div>
                </div>
                <div className="TermCond-box">
                    ...
                    <ul>
                        ...
                        <li><p><TiTick /></p><p><span>Amazing Indien Reisen UG</span> work as Travel agent for the services like hotels, airlines, transporters and railways.  We work with contractors who provide these services.</p></li>
                    ...
                    <div className="term-travel">
                        ...
                        <ul>
                            ...
                            <li><p><TiTick /></p><p><span>Wildlife Safaris cancellation</span>: All the Indian wildlife safaris arenon-refundable and non-transferrable. Any date change will affect 100 % cancellation charge; hence no payment will be refunded/ adjusted anywhere.</p></li>
